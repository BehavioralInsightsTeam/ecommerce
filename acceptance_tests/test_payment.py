...
from acceptance_tests.config import (VERIFIED_COURSE_ID, MARKETING_URL_ROOT,
                                     ENABLE_PAYPAL_TESTS, PAYPAL_PASSWORD, PAYPAL_EMAIL,
                                     ENABLE_STRIPE_TESTS, ENABLE_CYBERSOURCE_TESTS, BULK_PURCHASE_SKU)
...
class VerifiedCertificatePaymentTests(
    ...
    @skipUnless(ENABLE_PAYPAL_TESTS and BULK_PURCHASE_SKU,
                'Paypal tests are not enabled, or Bulk Purchase SKU not provided, skipping Bulk Purchase tests.')
